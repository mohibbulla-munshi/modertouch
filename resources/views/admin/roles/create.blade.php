...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 text-primary"><i class="bi bi-shield-plus me-2"></i>Create New Role</h4>
        <div class="page-header-sub text-muted">Define a new user role and its module permissions</div>
    </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="admin-card text-center p-4">
                <div class="mb-4 mt-2">
                    ...
                    <p class="text-muted small">Give this role a unique name.</p>
                </div>
                ...
                <div class="mb-4 text-start">
                    ...
                    <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" 
                           placeholder="e.g. Shop Manager" value="{{ old('name') }}" required
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <label class="w-100 p-3 bg-white border rounded position-relative" style="cursor:pointer; transition:all 0.2s; border-radius:12px !important;" onmouseover="this.style.borderColor='var(--teal)'; this.style.boxShadow='0 4px 12px rgba(0,0,0,0.05)'" onmouseout="if(!this.querySelector('input').checked){this.style.borderColor='var(--border)'; this.style.boxShadow='none'}">
                                    <div class="form-check m-0 d-flex align-items-center gap-2">
                                        <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{ $permission->name }}" id="perm_{{ $permission->id }}" style="width:18px;height:18px;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Custom styling for checked states
